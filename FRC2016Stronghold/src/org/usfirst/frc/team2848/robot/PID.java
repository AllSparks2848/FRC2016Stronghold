...
public class PID {
	...
	public PID(double pterm, double iterm, double dterm, double target, double starting_val) {
		...
		lastinput = starting_val; // gives a starting value to prevent big starting jump
	}
